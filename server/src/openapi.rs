...
pub fn build_spec() -> openapi::OpenApi {
    ...
    let paths = PathsBuilder::new()
        ...
        .path("/api/auth/magic-link/verify", PathItemBuilder::new()
            ...
            .build())
        // ── Businesses ────────────────────────────────────────────────────────
        .path("/api/businesses", PathItemBuilder::new()
            .operation(openapi::HttpMethod::Post, OperationBuilder::new()
                .summary(Some("Register a new partner business (attested users only)")).tag("businesses").build())
            .build())
        .path("/api/businesses/me", PathItemBuilder::new()
            .operation(openapi::HttpMethod::Get, OperationBuilder::new()
                .summary(Some("List businesses owned by the authenticated user")).tag("businesses").build())
            .build())
        .path("/api/businesses/{id}", PathItemBuilder::new()
            .operation(openapi::HttpMethod::Get, OperationBuilder::new()
                .summary(Some("Get a business by ID")).tag("businesses").build())
            .build())
        // ── Users ─────────────────────────────────────────────────────────────
